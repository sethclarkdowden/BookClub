Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  provider :google_oauth2, ENV['GOOGLE_OAUTH_CLIENT_ID'], ENV['GOOGLE_OAUTH_CLIENT_SECRET'], {access_type: 'online', approval_prompt: ''},
             {:scope => "userinfo.email, userinfo.profile, plus.me", :approval_prompt => "auto"}
end